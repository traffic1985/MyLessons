package com.ab360.anatolytweet.pojo;
...
public class User {
    ...
    public User(long id, String imageUrl, String name, String nick, String description, String locatoin, int followingCount, int followersCount) {
        this.id = id;
